...
def joinFactors(factors):
    ...
    for i in factors:
        temp_unconditioned = i.unconditionedVariables()
        temp_conditioned = i.conditionedVariables()
    ...
    for i in assignments:
        ...
        newFactor.setProbability(i, prob)
    ...
    def eliminate(factor, eliminationVariable):
        ...
        for assignment in newFactor.getAllPossibleAssignmentDicts():
            ...
            for i in domain:
                ...
                old_assignment[eliminationVariable] = i
...
def normalize(factor):
    ...
    for i in newFactor.getAllPossibleAssignmentDicts():
        prob = factor.getProbability(i)
        newFactor.setProbability(i, prob / prob_sum)
    return newFactor
